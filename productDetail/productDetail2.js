    ...
    productItem.innerHTML = `
      <a href="#none">
        ...
        <div class="contentPrice">
          ...
          <span><b class="star">${product.reviews}</b>
          ${product.ratings}개 리뷰</span>
        </div>
      </a>
    `;
...
$(document).ready(function () {
  $(".ulElements").on("click", "li", function () {
    ...
    if (productId) {
      ...
      console.error("Product ID가 없습니다.");
    }
    ...
    productItem.innerHTML = `
      ...
      product.product_name
              ...
              <div class="contentPrice">
                  ...
                  <span><b>${product.reviews}</b>${product.ratings}</span>
              </div>
          </a>
      `;
    productList.appendChild(productItem);
...
document.querySelector(".cart").addEventListener("click", function () {
  window.location.href = "../index.html"; // 장바구니 페이지로 이동
});
